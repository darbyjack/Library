package me.glaremasters.library.commands.base;

import me.glaremasters.library.util.ConfirmAction;
import me.glaremasters.library.util.IHandler;
...
public class CommandHandler implements CommandExecutor, TabCompleter, IHandler {
    ...
    public boolean onCommand(CommandSender sender, Command cmd, String commandLabel,
        ...
        if (!cmd.getName().equalsIgnoreCase("library")) {
            return true;
        }
